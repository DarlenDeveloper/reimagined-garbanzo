      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text('Wibble', style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
            ...
            const SizedBox(height: 32),
            Text('Made with love by Wibble Team', style: GoogleFonts.poppins(fontSize: 12, color: AppColors.textSecondary)),
            const SizedBox(height: 8),
            Text('© 2024 Wibble. All rights reserved.', style: GoogleFonts.poppins(fontSize: 11, color: AppColors.textSecondary)),
          ],
        ),
      ),
    );
