      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text('POP', style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
            ...
            const SizedBox(height: 32),
            Text('Made with love by J and POP Team', style: GoogleFonts.poppins(fontSize: 12, color: AppColors.textSecondary)),
            const SizedBox(height: 8),
            Text('© 2026 POP. All rights reserved.', style: GoogleFonts.poppins(fontSize: 11, color: AppColors.textSecondary)),
          ],
        ),
      ),
    );
