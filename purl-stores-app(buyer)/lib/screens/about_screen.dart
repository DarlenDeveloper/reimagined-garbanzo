        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset('assets/images/mainpurllogo.png', fit: BoxFit.cover),
            ),
            const SizedBox(height: 16),
            Text('Purl Stores', style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
            ...
            const SizedBox(height: 32),
            Text('Made with love by Purl Team', style: GoogleFonts.poppins(fontSize: 12, color: AppColors.textSecondary)),
            const SizedBox(height: 8),
            Text('© 2024 Purl Stores. All rights reserved.', style: GoogleFonts.poppins(fontSize: 11, color: AppColors.textSecondary)),
          ],
        ),
      ),
    );
