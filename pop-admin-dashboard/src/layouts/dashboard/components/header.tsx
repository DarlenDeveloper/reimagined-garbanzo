...
export function Header() {
  ...
  const handleOpenModal = () => {
    open("logout-confirmation", {
      content: <LogoutConfirmation onConfirm={signOut} />,
      animationType: "zoom",
    });
  };
    ...
    >
      ...
      <Sheet open={sheetOpen} onOpenChange={toggleSheet}>
        ...
        <SheetContent side="left" className="sm:max-w-xs">
          <VisuallyHidden>
            <SheetTitle>POP Admin</SheetTitle>
            <SheetDescription>POP Admin Dashboard</SheetDescription>
          </VisuallyHidden>
          <Logo />
      ...
      <div className="flex-1 flex gap-4 items-center justify-between">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <div>{adminUser?.name?.charAt(0).toUpperCase() || "A"}</div>
            </Button>
          </DropdownMenuTrigger>
