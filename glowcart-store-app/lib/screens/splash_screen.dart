                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: _bgFade.value > 0.5 ? Colors.black : Colors.white,
                            ...
                            child: Center(
                              child: Text(
                                ...
                                style: GoogleFonts.poppins(
                                  ...
                                  color: _bgFade.value > 0.5 ? Colors.white : Colors.black,
                                ),
                              ),
                            ),
                          ),
                        ...
                        Opacity(
                          ...
                          child: Column(
                            children: [
                              Text('GlowCart', style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.w700, color: Colors.white)),
                              Text('Store', style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey[400])),
                            ],
                          ),
                        ),
                      ],
