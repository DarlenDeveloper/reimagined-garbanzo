        ...
        children: [
          ShaderMask(
            shaderCallback: (bounds) => LinearGradient(
              colors: isDark ? [AppColors.limeAccent, const Color(0xFFC6D631)] : [AppColors.darkGreen, const Color(0xFF2D5A45)],
            ).createShader(bounds),
            child: Text(
              'Discover',
          ...
          const Spacer(),
          // Categories Icon
          _buildHeaderIcon(Iconsax.category, () {
            Navigator.push(context, MaterialPageRoute(builder: (_) => const CategoriesScreen()));
          }),
          const SizedBox(width: 8),
          // Map Icon
          _buildHeaderIcon(Iconsax.map, () {
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(Iconsax.setting_4, size: 20, color: context.isDark ? Colors.black : Colors.white),
            ),
          ),
        ],
      ),
              ...
              child: Center(
                child: Text(
                  ...
                  style: GoogleFonts.poppins(
                    ...
                    color: isSelected ? (context.isDark ? Colors.black : Colors.white) : context.textPrimaryColor,
                  ),
                ),
              ),
            ),
              ...
              child: Stack(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Icon(Iconsax.box, size: 50, color: Colors.grey.shade400),
                    ),
                  ),
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Iconsax.heart, size: 14, color: context.primaryColor),
                      ),
                    ),
                  ),
                ],
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Icon(Iconsax.message, size: 14, color: context.primaryColor),
                      ),
                    ],
                  ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                      'Reset',
                      style: GoogleFonts.poppins(fontSize: 14, color: isDark ? AppColors.limeAccent : AppColors.darkGreen),
                    ),
                  ),
                ],
              ),
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildFilterSection('Price Range', ['\$0-\$50', '\$50-\$100', '\$100-\$200', '\$200+'], isDark),
                    _buildFilterSection('Rating', ['4+ Stars', '3+ Stars', '2+ Stars', 'All'], isDark),
                    _buildFilterSection('Sort By', ['Popular', 'Newest', 'Price: Low to High', 'Price: High to Low'], isDark),
                  ],
                ),
              ),
            ),
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: isDark ? AppColors.limeAccent : AppColors.darkGreen,
        ...
        Wrap(
          ...
          children: options.map((option) {
            return Container(
              ...
              decoration: BoxDecoration(
                color: isDark ? AppColors.darkSurfaceVariant : const Color(0xFFF5F0E8),
                borderRadius: BorderRadius.circular(10),
              ),
              child: Text(
                option,
                style: GoogleFonts.poppins(fontSize: 13, color: isDark ? Colors.white : AppColors.textPrimary),
              ),
            );
          }).toList(),
        ),
