...
class _NotificationsScreenState extends State<NotificationsScreen> {
  final List<_NotificationItem> _notifications = [
    ...
    _NotificationItem(
      ...
      title: 'Order Shipped!',
      message: 'Your order #GC2847 has been shipped and is on its way.',
      time: '2 min ago',
      isRead: false,
      section: 'Today',
    ),
    _NotificationItem(
      ...
      message: 'Glow Electronics: 20% off all headphones. Use code GLOW20',
      time: '1 hour ago',
      isRead: false,
      section: 'Today',
    ...
    _NotificationItem(
      ...
      title: 'New Follower',
      message: 'Urban Style Co started following you',
      time: '3 hours ago',
      isRead: false,
      section: 'Today',
    ...
    _NotificationItem(
      ...
      message: 'Your order #GC2831 is out for delivery. Expected by 5 PM.',
      time: 'Yesterday',
      isRead: true,
      section: 'Yesterday',
    ),
    _NotificationItem(
      ...
      title: 'Post Liked',
      message: 'nikizefanya and 24 others liked your saved post',
      time: 'Yesterday',
      isRead: true,
      section: 'Yesterday',
    ),
    _NotificationItem(
      ...
      title: 'Back in Stock!',
      message: 'Smart Watch Ultra is back in stock at Glow Electronics',
      time: 'Yesterday',
      isRead: true,
      section: 'Yesterday',
      vendorName: 'Glow Electronics',
    ...
    _NotificationItem(
      ...
      message: 'Your order #GC2815 has been delivered successfully.',
      time: 'Monday',
      isRead: true,
      section: 'This Week',
    ),
    _NotificationItem(
      ...
      message: 'Home Essentials: 30% off all blankets and cushions',
      time: 'Sunday',
      isRead: true,
      section: 'This Week',
    ...
    _NotificationItem(
      ...
      title: 'New Message',
      message: 'vernadare sent you a message',
      time: 'Saturday',
      isRead: true,
      section: 'This Week',
    ),
  ...
  Color _getNotificationColor(NotificationType type) {
    ...
    switch (type) {
      case NotificationType.order:
        return isDark ? AppColors.limeAccent : AppColors.darkGreen;
      case NotificationType.delivery:
        return isDark ? AppColors.limeAccent : AppColors.darkGreen;
      case NotificationType.promo:
