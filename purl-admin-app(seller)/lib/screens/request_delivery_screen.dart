...
class _RequestDeliveryScreenState extends State<RequestDeliveryScreen> {
  ...
  final _pickupAddressController = TextEditingController(text: 'Purl Store, 123 Commerce St');
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 12),
              Text('Purl Delivery', style: GoogleFonts.poppins(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700)),
              const Spacer(),
              Container(
